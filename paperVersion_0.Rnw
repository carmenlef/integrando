...
Hago un chunk, todo lo que este fuera se genera como texto
<<titulo de lo que hace este chunk>>=
...
### tengo que poner ,fig=TRUE para que el comando me ponga el gráfico
