...
\usepackage{adjustbox}  % sirve para modificar el tamaño del grafico
% trim sirve para achicar el espacio entre el borde exterior del grafico
% y el grafico mismo.
%%%%
\usepackage{rotating}
...
% clip y trim deben ir juntos, trim va en sentido horario, el primero es la
% abajo bottom, right, top, right: ojo es lo que recorta el trim. 
